...
def update_memory(answer: Answer, top: List[Dict[str, Any]], verdict: Dict[str, Any]) -> Dict[str, Any]:
        ...
        with ChromaClient() as client:
            ...
            for chunk_id in cited_chunk_ids:
                ...
                try:
                    ...
                    client.update_chunk_stats(chunk_id, {
                        "useful_count": 1,
                        "last_useful_at": datetime.now().isoformat(),
            ...
            return {"updated_count": len(updated_chunks), "chunks": updated_chunks}
    
    except Exception as e:
        logger.error(f"Error updating memory: {e}")
        return {"updated_count": 0, "chunks": [], "error": str(e)}