#!/usr/bin/env python3
"""
Test client for the SSE server.
"""
        ...
        for line in response.iter_lines():
            if line:
                ...
                if line.startswith(b'data: '):
                    ...
                    event_type = None
                    if hasattr(test_query, 'previous_line') and test_query.previous_line.startswith(b'event: '):
                        event_type = test_query.previous_line[7:].decode('utf-8')
